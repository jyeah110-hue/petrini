...
<main class="biz-main">
  ...
  <div class="bt-wrap">
    ...
    <div class="bt-section">
      ...
      <div class="bt-grid">
        <div class="bt-group full"><label>재능나눔 제목 <span class="req">*</span></label><input type="text" value="${memberInfo.name} 무료 진료 재능나눔"></div>
    ...
    <div class="bt-section">
      ...
      <table class="biz-table">
        ...
        <tbody>
          <tr><td>2025.05.25</td><td>${memberInfo.name} 무료 진료 재능나눔</td><td>무료 진료</td><td>10건</td><td><span class="bs-badge bs-done">승인완료</span></td></tr>
          <tr><td>2025.04.27</td><td>${memberInfo.name} 무료 진료 재능나눔</td><td>무료 진료</td><td>8건</td><td><span class="bs-badge bs-done">완료</span></td></tr>
        </tbody>
      </table>
    </div>
  </div>
