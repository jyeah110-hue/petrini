...
<style>
  ...
  .complete-icon{width:80px;height:80px;border-radius:50%;background:#F3E8FF;display:flex;align-items:center;justify-content:center;margin:0 auto 24px}
  .complete-icon svg{width:40px;height:40px;stroke:#9333EA;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
  ...
  .complete-notice strong{color:#9333EA}
  .complete-btns{display:flex;gap:12px}
  .btn-complete-my{flex:1;padding:13px;border:2px solid #9333EA;border-radius:var(--radius-sm);background:#fff;color:#9333EA;font-size:15px;font-weight:700;cursor:pointer}
  .btn-complete-store{flex:1;padding:13px;border:none;border-radius:var(--radius-sm);background:#9333EA;color:#fff;font-size:15px;font-weight:700;cursor:pointer}
</style>
...
<div class="complete-wrap">
  ...
  <div class="complete-desc">예약번호 <strong>#STV-2025-0053</strong><br>예약 내역은 마이페이지에서 확인하세요.</div>
  <div class="complete-card">
    <h3>예약 정보</h3>
    <div class="complete-row"><span>예약번호</span><span>#STV-2025-0053</span></div>
    <div class="complete-row"><span>사진관</span><span>하루필름 스튜디오</span></div>
    ...
    <div class="complete-row"><span>촬영 패키지</span><span>베이직 (30,000원)</span></div>
  </div>
  <div class="complete-notice">
    촬영 시간 <strong>10분 전</strong>까지 방문해주세요. 예약 변경·취소는 마이페이지 &gt; 예약내역에서 가능합니다.
  </div>
  <div class="complete-btns">
    <button class="btn-complete-my" onclick="location.href='${contextPath}/mypage/reserve'">예약 내역 보기</button>
    <button class="btn-complete-store" onclick="location.href='${contextPath}/studio'">둘러보기 계속하기</button>
  </div>
</div>
